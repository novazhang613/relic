...
#endif /* FB_INV == ITOHT */
#endif /* WITH_FB */
// this stuff looks like a lot of space for precomputation to make code run faster. not sure if you need it or not. if not, you can get rid of it.
// the precomputaion is part of the algorithm... I think some uses this ... 
// well, this is for INV (inversion) seems, the algorithm I use doesn't need INV, if I remember correctly...
// we can try to comment it out?
// don't comment it out, do it via CMake. I'll show you how.
...
// If we change core_init() we will be break a lot of other things. Make a copy of core_init() and add the addr oiutputs.
//
