...
/* test fb multiplication (copy from test_fb.c multiplication) 
	 equivalently fb_mul_loadh(); [Comment: Here I use +define+YIQUN in order to call my LIM func]
	 equivalently fb_muln_low() + fb_rdc();
